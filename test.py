...
# print(awx.organization.organizations)
#
    ...
    def go(self):
        ...
        for item in self.orchestrate:
            ...
            try:
                ...
                self.awx.logger.warning('Project %s already exists.' % project)

            # lets delay for SCM update to finish
            # TODO: add a better check here
            # self.awx.logger.warning('Delay 15 seconds for SCM update to finish.')
            # time.sleep(15)
